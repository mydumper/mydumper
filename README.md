...
```bash
yum install https://github.com/maxbube/mydumper/releases/download/v0.10.5/mydumper-0.10.7-1.el7.x86_64.rpm
yum install https://github.com/maxbube/mydumper/releases/download/v0.10.5/mydumper-0.10.7-1.el8.x86_64.rpm
```
...
```bash
wget https://github.com/maxbube/mydumper/releases/download/v0.10.5/mydumper_0.10.7-1.$(lsb_release -cs)_amd64.deb
dpkg -i mydumper_0.10.7-1.$(lsb_release -cs)_amd64.deb
```
