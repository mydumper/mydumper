...
#    - prepare_ubuntu
    ...
    - run: cp /tmp/package/mydumper.1.gz /tmp/package/myloader.1.gz  mydumper.cnf mydumper myloader /tmp/src/mydumper/${all_os[${os}_0]}_${all_vendors[${vendor}_0]}_${all_arch[${arch}_deb]}/
