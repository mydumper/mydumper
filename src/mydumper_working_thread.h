...
//void new_table_to_dump(MYSQL *conn, struct configuration *conf, gboolean is_view, gboolean is_struct, struct database * database, char *table, char *collation, char *datalength, gchar *ecol);
void new_table_to_dump(MYSQL *conn, struct configuration *conf, gboolean is_view, gboolean is_sequence, struct database * database, char *table, char *collation, char *datalength, gchar *ecol, guint64 rows_in_st);
