...
static void detect_product(gchar *_ascii_version_comment, gchar *_ascii_version)
{
  ...
  else if ((ascii_version && g_strstr_len(ascii_version, -1, "mariadb")) || (ascii_version_comment && g_strstr_len(ascii_version_comment, -1, "mariadb")))
  {
    product = SERVER_TYPE_MARIADB;
  }
  else if ((ascii_version && g_strstr_len(ascii_version, -1, "tidb")) || (ascii_version_comment && g_strstr_len(ascii_version_comment, -1, "tidb")))
  {
    product = SERVER_TYPE_TIDB;
  }
  else if ((ascii_version && g_strstr_len(ascii_version, -1, "dolt")) || (ascii_version_comment && g_strstr_len(ascii_version_comment, -1, "dolt")))
  {
    product = SERVER_TYPE_DOLT;
  }
  else if ((ascii_version && g_strstr_len(ascii_version, -1, "google")) || (ascii_version_comment && g_strstr_len(ascii_version_comment, -1, "google")))
  {
    product = SERVER_TYPE_GOOGLE;
  }
  else if ((ascii_version && g_strstr_len(ascii_version, -1, "mysql")) || (ascii_version_comment && g_strstr_len(ascii_version_comment, -1, "mysql")) ||
...
static void detect_version(gchar **sver)
{
...
static void detect_server_version(MYSQL *conn)
{
...
static void detect_lower_case_table_names(MYSQL *conn)
{
