...
static GOptionEntry filter_entries[] = {
    ...
    {"skip-post", 0, 0, G_OPTION_ARG_NONE, &skip_post,
        "Do not import events, stored procedures and functions. Same as --skip-routines --skip-events. By default, it imports events, stored procedures or functions", NULL},
    {"skip-routines", 0, 0, G_OPTION_ARG_NONE, &skip_routines,
        "Do not import stored procedures and functions. By default, it imports stored procedures and functions", NULL},
    {"skip-events", 0, 0, G_OPTION_ARG_NONE, &skip_events,
        "Do not import events. By default, it imports events", NULL},
