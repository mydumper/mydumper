...
static GOptionEntry extra_entries[] = {
    ...
    {"bulk-metadata-prefetch", 0, 0, G_OPTION_ARG_NONE, &bulk_metadata_prefetch,
        ...
        "Significantly faster for dumping many tables, but slower for small dumps with -T",
        NULL},
...
static GOptionEntry lock_entries[] = {
    ...
    {"no-trx-tables", 0, G_OPTION_FLAG_OPTIONAL_ARG, G_OPTION_ARG_CALLBACK, &arguments_callback,
        ...
        "Locks will take longer to be released, as it needs to determine which tables are not transactional and export them before releasing global lock",
        NULL},
...
static GOptionEntry objects_entries[] = {
    ...
    {"skip-metadata-sorting", 0, 0, G_OPTION_ARG_NONE, &skip_metadata_sorting,
        ...
        "Only affects metadata file readability, not restore functionality",
        NULL},
