...
void      load_per_table_info_from_key_file(
    GKeyFile *kf, GHashTable *conf_per_table, struct function_pointer *init_function_pointer());
...
int   global_process_create_table_statement(
    gchar *statement, GString *create_table_statement, GString *alter_table_statement, GString *alter_table_constraint_statement, gchar *real_table, gboolean split_indexes);
