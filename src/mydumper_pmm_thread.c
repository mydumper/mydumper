...
void write_pmm_entries(GString *content, struct configuration* conf){
  ...
  append_pmm_entry(content,"object", "innodb_tables",     g_list_length(conf->innodb.table_list));
  append_pmm_entry(content,"object", "non_innodb_tables", g_list_length(conf->non_innodb.table_list));
